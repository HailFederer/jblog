				...
				<ul class="admin-menu">
		      	...
		      	<table class="admin-cat">
		      		...
		      		<c:forEach var="categoryVo" items="${list }">
						<tr>
							<td>${categoryVo.rowNum }</td>
							<td>${categoryVo.name }</td>
							<td>${categoryVo.postNum }</td>
							<td>${categoryVo.description }</td>
							<td>${categoryVo.reg_date }</td>
							<td><a href="${pageContext.request.contextPath}/${authUser.id}/admin/category/delete/${categoryVo.no}">
      			...
      			<form class="category-register-form" id="category-register-form" method="post" 
